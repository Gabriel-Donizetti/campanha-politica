  ...
  lopes: {
    candidate: {
      ...
      proposals: [
        {
          title: "Educação de qualidade",
          description: "Lopes acredita que a educação é fundamental para o desenvolvimento da sociedade. Ele propõe a construção de novas escolas, a formação contínua de professores e a implementação de tecnologias avançadas nas salas de aula. Seu objetivo é garantir que todas as crianças tenham acesso a uma educação de qualidade, independentemente de sua condição socioeconômica."
        },
        {
          title: "Saúde acessível",
          description: "Para Lopes, a saúde é um direito essencial. Sua proposta inclui a ampliação do atendimento nos postos de saúde, a contratação de mais profissionais qualificados e a modernização dos equipamentos médicos. Além disso, ele quer implementar programas de prevenção e promoção da saúde para melhorar a qualidade de vida da população."
        },
        {
          title: "Segurança pública",
          description: "A segurança é uma das prioridades de Lopes. Ele propõe o aumento do efetivo policial, a instalação de câmeras de vigilância em pontos estratégicos e a criação de programas comunitários de segurança. Com essas medidas, ele acredita que será possível reduzir a criminalidade e aumentar a tranquilidade para os moradores."
        },
        {
          title: "Meio ambiente sustentável",
          description: "Lopes é um defensor do meio ambiente. Sua proposta inclui a criação de áreas verdes, a implementação de programas de reciclagem e a promoção de energias renováveis. Ele acredita que, com políticas sustentáveis, é possível garantir um futuro mais saudável para as próximas gerações."
        },
        {
          title: "Transporte público eficiente",
          description: "Para melhorar a mobilidade urbana, Lopes propõe a modernização da frota de ônibus, a criação de ciclovias e a ampliação do metrô. Ele também quer implementar um sistema de bilhetagem integrada para facilitar o deslocamento dos cidadãos. Com um transporte público eficiente, ele acredita que será possível reduzir o trânsito e a poluição na cidade."
        },
        {
          title: "Habitação digna",
          description: "Lopes defende o direito à moradia digna para todos. Sua proposta inclui a construção de novas unidades habitacionais, a regularização fundiária de áreas irregulares e a implementação de programas de financiamento para a compra da casa própria. Ele acredita que, com essas medidas, será possível reduzir o déficit habitacional e melhorar a qualidade de vida das famílias."
        }
      ]
    }
  },
